package com.xu.wxxplatformserver.aspect;
...
import com.xu.wxxplatformserver.utils.RequestHolder;
import com.xu.wxxplatformserver.utils.ThrowableUtil;
...
public class AopLog {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.xu.wxxplatformserver.annotation.Log)")
